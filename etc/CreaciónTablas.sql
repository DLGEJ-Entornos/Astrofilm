...
Disponibles INT NULL, --Función Agregada (vista?)
...
PrecioNeto DECIMAL(3,2) NOT NULL, --Precio tras Descuento (premium?) FUNC AGREGADA?
...
CONSTRAINT ListaPeli_ListaFK FOREIGN KEY (IDListaFK)
REFERENCES LISTAS(IDLista),
CONSTRAINT ListaPeli_PeliFK FOREIGN KEY (IDPeliFK)
REFERENCES PELICULAS(IDPelicula)
);
go
...
CONSTRAINT PeliGenero_PeliFK FOREIGN KEY (IDPeliFK)
REFERENCES PELICULAS(IDPelicula),
CONSTRAINT PeliGenero_GeneroFK FOREIGN KEY (IDGeneroFK)
